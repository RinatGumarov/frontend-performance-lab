      ...
      <header className={styles.header}>
        ...
        <div>
          ...
          <p className={styles.summary}>
            The same dataset rendered two ways. Switch between the baseline and
            the optimized implementation and watch the render counters while you
            move the pointer across the chart.
          </p>
        </div>
      </header>
